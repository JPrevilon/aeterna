...
export const categories: { title: Category; slug: string; summary: string; image: string }[] = [
  { title: "Medical Weight Loss", slug: "medical-weight-loss", summary: "Provider-guided, consultation-first weight-loss support including Semaglutide and Tirzepatide programs when clinically appropriate. Results vary.", image: "/assets/treatments/medical-weight-loss.png" },
  { title: "Wellness Shots", slug: "wellness-shots", summary: "Quick injectable wellness support options including B12, B-Complex, Lipo-C, Glutathione, and more for energy, recovery, and metabolic support.", image: "/assets/treatments/wellness-shots.png" },
  { title: "IV Therapy", slug: "iv-therapy", summary: "Hydration, vitamin, and NAD+ IV therapy options designed to support recovery, energy, and wellness. Intake review required for some protocols.", image: "/assets/treatments/iv-therapy.png" },
  { title: "Hormone Balance", slug: "hormone-balance", summary: "Consultation-first hormone wellness support for estradiol, progesterone, and related concerns when clinically appropriate. Results vary.", image: "/assets/treatments/hormone-balance.png" },
  { title: "Testosterone & Men's Health", slug: "testosterone-mens-health", summary: "Private consultation and provider-guided TRT programs for energy, performance, and men's health when clinically appropriate. Results vary.", image: "/assets/treatments/mens-health.png" },
  { title: "Body Sculpting", slug: "body-sculpting", summary: "Non-invasive Emsculpt Neo body sculpting technology designed to support muscle building and fat reduction when clinically appropriate. Results vary.", image: "/assets/treatments/body-sculpting.png" },
