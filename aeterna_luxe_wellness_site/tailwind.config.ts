...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        sanctuary: "radial-gradient(ellipse at 16% 8%, rgba(200,169,106,.18), transparent 32%), radial-gradient(ellipse at 88% 0%, rgba(15,61,46,.10), transparent 28%), linear-gradient(135deg,#FFF9F0,#F5EFE4 48%,#EFE7DC)",
        ...
        espressoGlow: "radial-gradient(ellipse at 82% 8%, rgba(15,61,46,.20), transparent 34%), linear-gradient(135deg,#2F2118,#3A281D 54%,#241810)"
      }
    }
  }
};
